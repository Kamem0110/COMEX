...
$cliente2 = new Cliente( new \Pedro\Comex\Classes\CPF("123.456.789-10"),"Pedro Giusti","pedrogiusti@email.com","19895623142", $endereco);
...
$cliente2 = new Cliente( new \Pedro\Comex\Classes\CPF("789.456.123-10"),"José Roberto","jose@gmail.com","21985744152", $endereco);
